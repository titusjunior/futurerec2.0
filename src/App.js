...
function App({signOut, user}) { 
  ...
  if(userIsAdmin){
    return adminReturn({signOut, user, selectedPage, name});
  } else if(userIsTeacher){
    return teacherReturn({signOut, user, selectedPage, name});
  } else{
    return studentReturn({signOut, user, selectedPage, name});
  }
}

function studentReturn({signOut, user, selectedPage, name}){
  return (
    <>
    <meta charSet="UTF-8" />
...
function adminReturn({signOut, user, selectedPage, name}){
  return (
    <>
    <meta charSet="UTF-8" />
    <meta httpEquiv="X-UA-Compatible" content="IE=edge" />
      ...
      <ul>
        ...
        <li>
          <a href="#" onClick={() => changeContent('Add User')}>
            <i className="bx bx-bar-chart" />
            <span className="nav-item">Add User</span>
          </a>
        ...
        <li>
          <a href="#" onClick={() => changeContent('Set Classes')}>
            <i className="bx bxs-pencil" />
            <span className="nav-item">Set Classes</span>
          </a>
          <span className="tooltip">Set Classes</span>
        </li>
        <li>
          <button className="logout"><img src={logoutImg} alt="my image" onClick={signOut} /></button>
        </li>
...
function teacherReturn({signOut, user, selectedPage, name}){
  return (
    <>
    <meta charSet="UTF-8" />
    <meta httpEquiv="X-UA-Compatible" content="IE=edge" />
